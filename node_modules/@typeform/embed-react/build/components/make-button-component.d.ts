import { CSSProperties, ReactNode, ReactHTML, HTMLAttributes } from 'react';
...
declare function makeButtonComponent<T>(createFn: CreateFn<T>, cssFilename: string): ({ id, children, as, style, className, buttonProps, ...props }: ButtonComponentProps<T>) => JSX.Element;
