...
import { blob, struct, u8, s32, u32, seq } from '@solana/buffer-layout';
import { PublicKey, sendAndConfirmTransaction as sendAndConfirmTransaction$1, TransactionInstruction, Transaction, SystemProgram, Keypair } from '@solana/web3.js';
import BN from 'bn.js';
import { Token, ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, AccountLayout, u64, MintLayout } from '@solana/spl-token';
...
var TEN = /*#__PURE__*/new Decimal(10);
var P64 = /*#__PURE__*/new Decimal(2).pow(64);
...
var DecimalExt = /*#__PURE__*/function () {
  ...
  DecimalExt.from64Buffer = function from64Buffer(buffer, precision) {
    ...
    !(buffer.length === 8) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid buffer length: " + buffer.length) : invariant(false) : void 0;
    !(Math.abs(precision) < MAX_PRECISION) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid precision: " + precision) : invariant(false) : void 0;
  ...
  DecimalExt.from128Buffer = function from128Buffer(buffer, precision) {
    ...
    !(buffer.length === 16) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid buffer length: " + buffer.length) : invariant(false) : void 0;
    !(Math.abs(precision) < MAX_PRECISION) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid precision: " + precision) : invariant(false) : void 0;
  ...
  DecimalExt.to64Buffer = function to64Buffer(v, precision) {
    ...
    !(v.greaterThanOrEqualTo(MIN_INT64) && v.lessThanOrEqualTo(MAX_INT64)) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid v: " + v.toString() + " to int128 buffer with precision: " + precision) : invariant(false) : void 0;
  ...
  DecimalExt.toU64Buffer = function toU64Buffer(v, precision) {
    ...
    !(Math.abs(precision) < MAX_PRECISION) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid precision: " + precision) : invariant(false) : void 0;
    v = v.mul(TEN.pow(precision)).round();
    !(v.greaterThanOrEqualTo(0) && v.lessThanOrEqualTo(MAX_UINT64)) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid v: " + v.toString() + " to uint64 buffer with precision: " + precision) : invariant(false) : void 0;
  ...
  DecimalExt.to128Buffer = function to128Buffer(v, precision) {
    ...
    !(Math.abs(precision) < MAX_PRECISION) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid precision: " + precision) : invariant(false) : void 0;
    v = v.mul(TEN.pow(precision)).round();
    !(v.greaterThanOrEqualTo(MIN_INT128) && v.lessThanOrEqualTo(MAX_INT128)) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid v: " + v.toString() + " to int128 buffer with precision: " + precision) : invariant(false) : void 0;
    var bn = new BN(v.toString());
  ...
  DecimalExt.toU128Buffer = function toU128Buffer(v, precision) {
    ...
    !(Math.abs(precision) < MAX_PRECISION) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid precision: " + precision) : invariant(false) : void 0;
    v = v.mul(TEN.pow(precision)).round();
    !(v.greaterThanOrEqualTo(0) && v.lessThanOrEqualTo(MAX_UINT128)) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid v: " + v.toString() + " to int128 buffer with precision: " + precision) : invariant(false) : void 0;
...
var decimal64 = function decimal64(property, precision) {
  ...
  var layout = blob(8, property); //const { encode, decode } = encodeDecode(layout);
...
var decimal128 = function decimal128(property, precision) {
  ...
  var layout = blob(16, property); //const { encode, decode } = encodeDecode(layout);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", sendAndConfirmTransaction$1(conn, transaction, signers, {
              skipPreflight: false,
              commitment: "recent",
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return Token.getAssociatedTokenAddress(ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, tokenMint, owner, true);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            !((account == null ? void 0 : account.data) != null) ? process.env.NODE_ENV !== "production" ? invariant(false, "The token account:" + address.toBase58() + " data is null") : invariant(false) : void 0;
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            for (i = 0; i < accounts.value.length; i++) {
              ...
              !((account == null ? void 0 : account.data) != null) ? process.env.NODE_ENV !== "production" ? invariant(false, "The token account:" + pubkey.toBase58() + " data is null") : invariant(false) : void 0;
              accountInfo = parseTokenAccount(account);
...
function parseTokenAccount(account) {
  !((account == null ? void 0 : account.data) != null) ? process.env.NODE_ENV !== "production" ? invariant(false, "The account data is null") : invariant(false) : void 0;
  var accountInfo = AccountLayout.decode(account == null ? void 0 : account.data);
  accountInfo.mint = new PublicKey(accountInfo.mint);
  accountInfo.owner = new PublicKey(accountInfo.owner);
  accountInfo.amount = u64.fromBuffer(accountInfo.amount);
...
var DataLayout = /*#__PURE__*/struct([/*#__PURE__*/u8("instruction")]);
...
var DataLayout$1 = /*#__PURE__*/struct([/*#__PURE__*/u8("instruction"), /*#__PURE__*/decimalU64("positionIndex")]);
...
var DataLayout$2 = /*#__PURE__*/struct([/*#__PURE__*/u8("instruction"), /*#__PURE__*/u8("isNewPosition"), /*#__PURE__*/decimalU128("liquityAmount"), /*#__PURE__*/s32("tickLower"), /*#__PURE__*/s32("tickUpper"), /*#__PURE__*/decimalU64("maximumTokenA"), /*#__PURE__*/decimalU64("maximumTokenB"), /*#__PURE__*/decimalU64("positionIndex")]);
...
var DataLayout$3 = /*#__PURE__*/struct([/*#__PURE__*/u8("instruction"), /*#__PURE__*/u8("nonce"), /*#__PURE__*/u8("curveType"), /*#__PURE__*/decimalU64("fee", 12), /*#__PURE__*/decimalU64("managerFee", 12), /*#__PURE__*/u32("tickSpace"), /*#__PURE__*/decimalU128("currentSqrtPrice", 12), /*#__PURE__*/decimalU128("currentLiquity"), /*#__PURE__*/decimalU128("feeGrowthGlobal0"), /*#__PURE__*/decimalU128("feeGrowthGlobal1"), /*#__PURE__*/decimalU128("managerFeeA"), /*#__PURE__*/decimalU128("managerFeeB")]);
...
var DataLayout$4 = /*#__PURE__*/struct([/*#__PURE__*/u8("instruction")]);
...
var DataLayout$5 = /*#__PURE__*/struct([/*#__PURE__*/u8("instruction"), /*#__PURE__*/decimalU64("amountIn"), /*#__PURE__*/decimalU64("minimumAmountOut")]);
...
var DataLayout$6 = /*#__PURE__*/struct([/*#__PURE__*/u8("instruction"), /*#__PURE__*/decimalU64("liquityAmount"), /*#__PURE__*/decimalU64("minimumTokenA"), /*#__PURE__*/decimalU64("minimumTokenB"), /*#__PURE__*/decimalU64("positionIndex")]);
...
var DataLayout$7 = /*#__PURE__*/struct([/*#__PURE__*/u8("instruction"), /*#__PURE__*/decimalU64("amountIn"),
/*#__PURE__*/
...
var TickLayout = /*#__PURE__*/struct([/*#__PURE__*/s32("tick"), /*#__PURE__*/decimalU128("tickPrice", 12), /*#__PURE__*/decimalU128("liquityGross"), /*#__PURE__*/decimal128("liquityNet"), /*#__PURE__*/decimalU128("feeGrowthOutside0", 16), /*#__PURE__*/decimalU128("feeGrowthOutside1", 16)], "tickInfo");
var TicksAccountLayout = /*#__PURE__*/struct([/*#__PURE__*/u8("swapVersion"), /*#__PURE__*/publicKey("tokenSwapKey"), /*#__PURE__*/u8("accountType"), /*#__PURE__*/s32("len"), /*#__PURE__*/blob(TICKS_ACCOUNT_SIZE - 38, "dataFlat")], "ticksAccount");
...
var parseTicksAccount = function parseTicksAccount(pubkey, info) {
  ...
  var ticks = seq(TickLayout, len).decode(ticksBuffer);
  var ticksAccount = {
...
var PositionLayout = /*#__PURE__*/struct([/*#__PURE__*/publicKey("nftTokenId"), /*#__PURE__*/s32("lowerTick"), /*#__PURE__*/s32("upperTick"), /*#__PURE__*/decimalU128("liquity"), /*#__PURE__*/decimalU128("feeGrowthInsideALast", 16), /*#__PURE__*/decimalU128("feeGrowthInsideBLast", 16), /*#__PURE__*/decimalU128("tokenAFee", 16), /*#__PURE__*/decimalU128("tokenBFee", 16)], "position");
var PositionsAccountLayout = /*#__PURE__*/struct([/*#__PURE__*/u8("swapVersion"), /*#__PURE__*/publicKey("tokenSwapKey"), /*#__PURE__*/u8("accountType"), /*#__PURE__*/s32("len"), /*#__PURE__*/blob(POSITIONS_ACCOUNT_SIZE - 38, "dataFlat")], "positionsAccount");
...
var parsePositionsAccount = function parsePositionsAccount(pubkey, info) {
  ...
  var positions = seq(PositionLayout, len).decode(positionsBuffer);
...
var TokenSwapAccountLayout = /*#__PURE__*/struct([/*#__PURE__*/publicKey("tokenSwapKey"), /*#__PURE__*/u8("accountType"), /*#__PURE__*/u8("version"), /*#__PURE__*/u8("isInitialized"), /*#__PURE__*/u8("nonce"), /*#__PURE__*/publicKey("tokenProgramId"), /*#__PURE__*/publicKey("manager"), /*#__PURE__*/publicKey("managerTokenA"), /*#__PURE__*/publicKey("managerTokenB"), /*#__PURE__*/publicKey("swapTokenA"), /*#__PURE__*/publicKey("swapTokenB"), /*#__PURE__*/publicKey("tokenAMint"), /*#__PURE__*/publicKey("tokenBMint"), /*#__PURE__*/publicKey("ticksKey"), /*#__PURE__*/publicKey("positionsKey"), /*#__PURE__*/u8("curveType"), /*#__PURE__*/decimalU64("fee", 12), /*#__PURE__*/decimalU64("managerFee", 12), /*#__PURE__*/u32("tickSpace"), /*#__PURE__*/decimalU128("currentSqrtPrice", 12), /*#__PURE__*/decimalU128("currentLiquity"), /*#__PURE__*/decimalU128("feeGrowthGlobal0", 16), /*#__PURE__*/decimalU128("feeGrowthGlobal1", 16), /*#__PURE__*/decimalU128("managerFeeA"), /*#__PURE__*/decimalU128("managerFeeB")], "tokenSwapAccount");
...
var PIECES = /*#__PURE__*/new Decimal$1("1.0001");
var PRICE_OFFSET = /*#__PURE__*/new Decimal$1("1e-12");
...
function sqrtPrice2Tick(sqrtPrice) {
  !sqrtPrice.lessThan(MAX_SQRT_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid sqrtPrice: " + sqrtPrice.toString() + " Max: " + MAX_SQRT_PRICE + ", too large") : invariant(false) : void 0;
  !sqrtPrice.greaterThan(MIN_SQRT_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid sqrtPrice: " + sqrtPrice.toString() + ", Min: " + MIN_SQRT_PRICE + ", too small") : invariant(false) : void 0;
  return sqrtPrice.pow(2).log(PIECES).toDP(0, Decimal$1.ROUND_HALF_UP).toNumber();
}
/**
...
function tick2SqrtPrice(tick) {
  !(tick >= MIN_TICK && tick <= MAX_TICK) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid tick: " + tick + ", must be in range [" + MIN_TICK + ", " + MAX_TICK + "]") : invariant(false) : void 0;
...
function price2Tick(price) {
  !price.lessThan(MAX_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid price:" + price.toString() + " Max: " + MAX_PRICE + ",  too large") : invariant(false) : void 0;
  !price.greaterThan(MIN_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid price:" + price.toString() + " Min: " + MIN_PRICE + ", too small") : invariant(false) : void 0;
  return price.log(PIECES).toDP(0, Decimal$1.ROUND_HALF_UP).toNumber();
}
/**
...
function getNearestTickBySqrtPrice(sqrtPrice, tickSpace) {
  !(tickSpace > 0 && tickSpace % 1 === 0) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid tickSpace:" + tickSpace) : invariant(false) : void 0;
  !sqrtPrice.lessThan(MAX_SQRT_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid sqrtPrice: " + sqrtPrice.toString() + " Max: " + MAX_SQRT_PRICE + ", too large") : invariant(false) : void 0;
  !sqrtPrice.greaterThan(MIN_SQRT_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid sqrtPrice: " + sqrtPrice.toString() + ", Min: " + MIN_SQRT_PRICE + ", too small") : invariant(false) : void 0;
...
function calculateSwapA2B(ticks, currentSqrtPrice, fee, currentLiquity, amountIn) {
  !amountIn.greaterThan(new Decimal$1(0)) ? process.env.NODE_ENV !== "production" ? invariant(false, "invalid amount in") : invariant(false) : void 0;
  !currentLiquity.greaterThanOrEqualTo(new Decimal$1(0)) ? process.env.NODE_ENV !== "production" ? invariant(false, "invalid liquity") : invariant(false) : void 0;
  !(ticks.length > 0) ? process.env.NODE_ENV !== "production" ? invariant(false, "the ticks is empty") : invariant(false) : void 0; //let currentTick = sqrtPrice2Tick(currentSqrtPrice);

  !(currentSqrtPrice > ticks[0].tickPrice) ? process.env.NODE_ENV !== "production" ? invariant(false, "out of ticks") : invariant(false) : void 0;
  var liquity = currentLiquity;
  var out = new Decimal$1(0);
  var remind = amountIn;
  var remindWithFee = new Decimal$1(0);
  var feeUsed = new Decimal$1(0);
  var amountUsed = new Decimal$1(0);

  for (var i = ticks.length - 1; i >= 0; i--) {
    if (liquity.equals(new Decimal$1(0))) {
    ...
    var fullStepFee = maxAmountIn.mul(fee).toDP(0, Decimal$1.ROUND_DOWN);
    ...
    if (maxAmountIn.greaterThanOrEqualTo(remindWithFee)) {
      remindWithFee = remind.mul(new Decimal$1(1).sub(fee)).toDP(0, Decimal$1.ROUND_UP);
...
function calculateSwapB2A(ticks, currentSqrtPrice, fee, currentLiquity, amountIn) {
  ...
  !currentSqrtPrice.lessThan(ticks[ticks.length - 1].tickPrice) ? process.env.NODE_ENV !== "production" ? invariant(false, "out of ticks") : invariant(false) : void 0;
  var liquity = currentLiquity;
  var out = new Decimal$1(0);
  var remind = amountIn;
  var remindWithFee = new Decimal$1(0);
...
function maxAmountA(lowerSqrtPrice, upperSqrtPrice, liquity) {
  return liquity.div(lowerSqrtPrice).toDP(0, Decimal$1.ROUND_DOWN).sub(liquity.div(upperSqrtPrice).toDP(0, Decimal$1.ROUND_DOWN));
}
/** @internal */

function maxAmountB(lowerSqrtPrice, upperSqrtPrice, liquity) {
  return liquity.mul(upperSqrtPrice.sub(lowerSqrtPrice)).toDP(0, Decimal$1.ROUND_DOWN);
}
/** @internal */

function swapA2B(upperSqrtPrice, liquity, amountIn) {
  var afterSqrtPrice = liquity.div(amountIn.add(liquity.div(upperSqrtPrice)));
  var delta_increase = amountIn.add(liquity.div(upperSqrtPrice).toDP(0, Decimal$1.ROUND_DOWN));
  var out = liquity.mul(upperSqrtPrice).toDP(0, Decimal$1.ROUND_DOWN).sub(liquity.mul(liquity).div(delta_increase).toDP(0, Decimal$1.ROUND_DOWN));
  return {
    amountOut: out,
...
function swapB2A(lowerSqrtPrice, liquity, amountIn) {
  ...
  var delta_increase = amountIn.add(liquity.mul(lowerSqrtPrice).toDP(0, Decimal$1.ROUND_DOWN));
  var out = liquity.div(lowerSqrtPrice).toDP(0, Decimal$1.ROUND_DOWN).sub(liquity.mul(liquity).div(delta_increase).toDP(0, Decimal$1.ROUND_DOWN));
  return {
    amountOut: out,
    afterSqrtPrice: afterSqrtPrice
  };
...
function calculateLiquity(tickLower, tickUpper, desiredAmountSrc, currentSqrtPrice, direct) {
  !(tickLower < tickUpper) ? process.env.NODE_ENV !== "production" ? invariant(false, "The tickLower must less than tickUpper") : invariant(false) : void 0;
  var lowerSqrtPrice = tick2SqrtPrice(tickLower);
  var upperSqrtPrice = tick2SqrtPrice(tickUpper);
  !(currentSqrtPrice.greaterThanOrEqualTo(lowerSqrtPrice) && currentSqrtPrice.lessThanOrEqualTo(upperSqrtPrice)) ? process.env.NODE_ENV !== "production" ? invariant(false, "The current price must in [lowerPrice,upperPrice]") : invariant(false) : void 0;
...
function calculateLiquityTable(ticks) {
  var minLiquity = new Decimal(0);
  var maxLiquity = new Decimal(0);
  var liquitys = [];
  var liquity = {
    lowerTick: 0,
    upperTick: 0,
...
var INIT_KEY = /*#__PURE__*/new PublicKey("11111111111111111111111111111111");
Decimal.config({
  precision: 64,
...
var TokenSwap = /*#__PURE__*/function () {
            ...
            case 3:
              ...
              accounts.map(function (item) {
                if (isTokenSwapAccount(item.account)) {
                  ...
                  !((info == null ? void 0 : info.data) !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, "The token swap account parse failed") : invariant(false) : void 0;
                  _this.tokenSwapInfo = info.data;
                } else if (isTicksAccount(item.account)) {
                  var _info = parseTicksAccount(item.pubkey, item.account);

                  !((_info == null ? void 0 : _info.data) !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, "The tick account parse failed") : invariant(false) : void 0;
                  ...
                  !((_info2 == null ? void 0 : _info2.data) !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, "The position account data parse failed") : invariant(false) : void 0;
              ...
              _context.next = 8;
              return PublicKey.findProgramAddress([this.tokenSwapKey.toBuffer()], this.programId);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              ticksAccount = Keypair.generate();
              positionsAccount = Keypair.generate();
              _context2.next = 6;
              return PublicKey.findProgramAddress([tokenSwapAccount.publicKey.toBuffer()], programId);
            ...
            case 24:
              ...
              tokenA = new Token(conn, tokenAMint, TOKEN_PROGRAM_ID, payer);
              tokenB = new Token(conn, tokenBMint, TOKEN_PROGRAM_ID, payer);
              _context2.next = 31;
      ...
      return runtime_1.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              !(lowerTick < upperTick) ? process.env.NODE_ENV !== "production" ? invariant(false, "The lowerTick must be less than upperTick") : invariant(false) : void 0;
              payer = payer != null ? payer : this.payer;
              !(payer != null) ? process.env.NODE_ENV !== "production" ? invariant(false, "The payer is null") : invariant(false) : void 0; // Generate create position nft token instructions

              nftMintAccount = Keypair.generate();
              _context3.next = 10;
            ...
            case 10:
              ...
              _context3.next = 13;
              return Token.getMinBalanceRentForExemptAccount(this.conn);

            case 13:
              accountLamports = _context3.sent;
              positionsKey = this.choosePosition();
              !(positionsKey != null) ? process.env.NODE_ENV !== "production" ? invariant(false, "The position account space is full") : invariant(false) : void 0;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 4:
              ...
              !(positionInfo != undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, "Position:" + positionId + " not found") : invariant(false) : void 0;
              payer = payer != null ? payer : this.payer;
              !(payer !== null) ? process.env.NODE_ENV !== "production" ? invariant(false, "The payer is null") : invariant(false) : void 0;
              nftToken = new Token(this.conn, positionId, TOKEN_PROGRAM_ID, payer);
            ...
            case 15:
              ...
              !(nftUser.amount.toNumber() === 1) ? process.env.NODE_ENV !== "production" ? invariant(false, "You not hold this position:" + nftToken.publicKey.toBase58()) : invariant(false) : void 0; // Generate mint positon instruction
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 4:
              ...
              transaction = new Transaction().add(swapInstruction(this.programId, this.tokenSwapKey, this.authority, userTransferAuthority.publicKey, userSource, userDestination, swapSrc, swapDst, this.tokenSwapInfo.ticksKey, amountIn, minimumAmountOut)); // send and confirm transaction
      ...
      return runtime_1.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 3:
              transaction = new Transaction().add(simulateSwapInstruction(this.programId, this.tokenSwapKey, this.tokenSwapInfo.ticksKey, amountIn, direction));
              _context7.next = 6;
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 15:
              ...
              !(nftUser.amount.toNumber() === 1) ? process.env.NODE_ENV !== "production" ? invariant(false, "You not hold this position:" + nftToken.publicKey.toBase58()) : invariant(false) : void 0;
              transaction = new Transaction().add(claimInstruction(this.programId, this.tokenSwapKey, this.authority, payer.publicKey, this.tokenSwapInfo.swapTokenB, this.tokenSwapInfo.swapTokenB, userTokenA, userTokenB, positionId, nftUser.address, this.tokenSwapInfo.ticksKey, positionInfo.positionsKey, positionInfo.index)); // send and confirm transaction
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 4:
              payer = payer != null ? payer : this.payer;
              !(payer !== null) ? process.env.NODE_ENV !== "production" ? invariant(false, "The payer is null") : invariant(false) : void 0;
              transaction = new Transaction().add(managerClaimInstruction(this.programId, this.tokenSwapKey, this.authority, payer.publicKey, this.tokenSwapInfo.swapTokenA, this.tokenSwapInfo.swapTokenB, userTokenA, userTokenB)); // send and confirm transaction
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              payer = payer != null ? payer : this.payer;
              !(payer !== null) ? process.env.NODE_ENV !== "production" ? invariant(false, "The payer is null") : invariant(false) : void 0;
              token = new Token(this.conn, tokenMint, TOKEN_PROGRAM_ID, payer);
              _context11.next = 6;
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              ...
              !this.isLoaded ? process.env.NODE_ENV !== "production" ? invariant(false, "The token swap not load") : invariant(false) : void 0;
              owner = owner != undefined ? owner : (_this$payer = this.payer) == null ? void 0 : _this$payer.publicKey;
              !(owner !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, "The owner is undefined") : invariant(false) : void 0;
              _context12.next = 6;
  ...
  _proto.calculateLiquityByTokenA = function calculateLiquityByTokenA(tickLower, tickUpper, desiredAmountA) {
    !this.isLoaded ? process.env.NODE_ENV !== "production" ? invariant(false, "The token swap not load") : invariant(false) : void 0;
    !(this.currentTick <= tickUpper) ? process.env.NODE_ENV !== "production" ? invariant(false, "The current price must less than lower price") : invariant(false) : void 0;
  ...
  _proto.calculateLiquityByTokenB = function calculateLiquityByTokenB(tickLower, tickUpper, desiredAmountB) {
    !this.isLoaded ? process.env.NODE_ENV !== "production" ? invariant(false, "The token swap not load") : invariant(false) : void 0;
    !(this.currentTick >= tickLower) ? process.env.NODE_ENV !== "production" ? invariant(false, "The current price must less than lower price") : invariant(false) : void 0;
  ...
  _proto.calculatePositionValue = function calculatePositionValue(positionId) {
    ...
    !(positionInfo !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, "The position:" + positionId.toBase58() + " not found") : invariant(false) : void 0;
  ...
  _proto.preCollect = function preCollect(positionId) {
    ...
    !(lowerTick !== null) ? process.env.NODE_ENV !== "production" ? invariant(false, "The position lower tick:" + positionInfo.lowerTick + " not found") : invariant(false) : void 0;
    !(upperTick !== null) ? process.env.NODE_ENV !== "production" ? invariant(false, "The position upper tick:" + positionInfo.upperTick + " not found") : invariant(false) : void 0;
    var lowerFeeOutSideA = new Decimal(0);
    var lowerFeeOutSideB = new Decimal(0);
    var upperFeeOutSideA = new Decimal(0);
    var upperFeeOutSideB = new Decimal(0);
  ...
  _proto.preSwapA = function preSwapA(amountIn) {
    ...
    var currentPriceB = new Decimal(1).div(currentPriceA);
    ...
    var afterPriceB = new Decimal(1).div(afterPriceA);
    return {
...
export { INIT_KEY, MAX_ACCOUNT_POSITION_LENGTH, MAX_PRICE, MAX_SQRT_PRICE, MAX_TICK, MIN_PRICE, MIN_SQRT_PRICE, MIN_TICK, PIECES, POSITIONS_ACCOUNT_SIZE, PRICE_OFFSET, PositionLayout, PositionsAccountLayout, TICKS_ACCOUNT_SIZE, TOKEN_SWAP_ACCOUNT_SIZE, TickLayout, TicksAccountLayout, TokenSwap, TokenSwapAccountLayout, calculateLiquity, calculateLiquityOnlyA, calculateLiquityOnlyB, calculateLiquityTable, calculateSwapA2B, calculateSwapB2A, calculateTokenAmount, createAssociatedTokenAccountInstruction, decimal128, decimal64, decimalU128, decimalU64, encodeDecode, getAssociatedTokenAddress, getNearestTick, getNearestTickByPrice, getNearestTickBySqrtPrice, getTokenAccount, getTokenAccounts, int128, int64, isPositionsAccount, isTicksAccount, isTokenSwapAccount, maxAmountA, maxAmountB, parsePositionsAccount, parseTicksAccount, parseTokenAccount, parseTokenAccountData, parseTokenSwapAccount, price2Tick, publicKey, sendAndConfirmTransaction, sqrtPrice2Tick, swapA2B, swapB2A, tick2Price, tick2SqrtPrice, uint128, uint64 };
//# sourceMappingURL=crema-sdk.esm.js.map
