...
class TokenOwner {
     ...
     */
    async getATA(mint) {
        return await (0, _1.getATAAddress)({ mint, owner: this.owner });
    }
    /**
    ...
    async transfer(amount, to) {
        return _1.SPLToken.createTransferInstruction(_1.TOKEN_PROGRAM_ID, await this.getATA(amount.token.mintAccount), to, this.owner, [], amount.toU64());
    }
    /**
    ...
    async transferChecked(amount, to) {
        return _1.SPLToken.createTransferCheckedInstruction(_1.TOKEN_PROGRAM_ID, await this.getATA(amount.token.mintAccount), amount.token.mintAccount, to, this.owner, [], amount.toU64(), amount.token.decimals);
    }
    /**
    ...
    async createATA(mint, payer = this.owner) {
        return _1.SPLToken.createAssociatedTokenAccountInstruction(_1.ASSOCIATED_TOKEN_PROGRAM_ID, _1.TOKEN_PROGRAM_ID, mint, await this.getATA(mint), this.owner, payer);
    }
}
