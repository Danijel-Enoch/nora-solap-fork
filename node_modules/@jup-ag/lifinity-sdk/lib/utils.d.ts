...
export declare function createWSOLAccountIfNotExist(program: Program<LifinityAmmType>, account: PublicKey | undefined | null, amountIn: number, transaction: Transaction, signer: any[]): Promise<PublicKey>;
export declare function createAssociatedTokenAccountIfNotExist(program: Program<LifinityAmmType>, tokenMintAddress: PublicKey, transaction: Transaction): Promise<PublicKey>;
...
export declare function getParsedData(multipleInfo: Array<null | {
    publicKey: PublicKey;
    account: AccountInfo<Buffer>;
