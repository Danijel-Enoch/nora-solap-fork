...
const SwapTokenSelect = ({
  ...
  const popularTokenSymbols = ['USDC', 'SOL', 'USDT', 'SOLAPE', 'BTC', 'ETH']
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} hideClose noPadding alignTop className="solape__token-select">
        ...
        {popularTokens.length && onTokenSelect ? (
          <div className="flex flex-wrap px-4">
            {popularTokens.map((token) => (
              <button
                className="mx-1 mb-2 flex items-center rounded-md border border-transparent bg-th-bkg-3 py-2 px-3 hover:border-th-fgd-3 focus:border-th-fgd-2"
