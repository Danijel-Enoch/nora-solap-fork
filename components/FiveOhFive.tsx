...
export const FiveOhFive = ({ error }) => {
  ...
  return (
    <div className="flex h-screen flex-col bg-th-bkg-1">
      <div className="absolute top-0 h-2 w-full bg-gradient-to-r from-solape-theme-green via-solape-theme-yellow-dark to-solape-theme-red-dark"></div>
        ...
        <div className="mx-auto max-w-xl py-16 sm:py-24">
          ...
          <div className="my-10 text-center">
            <div className="font-mono mt-8 rounded-lg bg-th-bkg-2 p-8 text-left text-th-fgd-1">
              <div className="flex">
                <div className="text-solape-theme-fgd-2">{error.message}</div>
                <div className="flex-grow"></div>
                <div className="flex-shrink-0 self-center">
                  <Icon
                    className="text-solape-yellow h-5 w-5"
                    aria-hidden="true"
            ...
            <div className="flex flex-col items-center">
              <div className="mt-10 flex flex-row">
                ...
                <a
                  className="whitespace-nowrap rounded-full bg-solape-theme-bkg-3 px-6 py-2 font-bold text-th-fgd-1 hover:brightness-[1.1] focus:outline-none disabled:cursor-not-allowed disabled:bg-th-bkg-4 disabled:text-th-fgd-4 disabled:hover:brightness-100"
      ...
      <div className="absolute bottom-0 h-2 w-full bg-gradient-to-r from-solape-theme-green via-solape-theme-yellow-dark to-solape-theme-red-dark"></div>
    </div>
  )
}
