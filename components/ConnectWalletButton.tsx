      ...
      {connected && publicKey ? (
        ...
        >
          <button
            ...
            disabled={!mangoGroup}
            className="solape__connect-btn rounded-none rounded-l-lg bg-th-primary-dark text-th-bkg-1 focus:outline-none disabled:cursor-wait disabled:text-th-bkg-2"
          >
            <div className="default-transition flex h-full flex-row items-center justify-center px-3">
              ...
              <div className="text-left">
                <div className="mb-0 whitespace-nowrap font-normal leading-none">
                  <span>{t('Connect')}</span>
                </div>
                {/*{wallet?.adapter?.name && (
