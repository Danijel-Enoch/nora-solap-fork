...
const SideNav = ({ collapsed }) => {
  ...
  return (
    <div
      ...
      } min-h-screen border-r border-th-bkg-3 bg-th-bkg-2`}
    >
      <div className="mb-4">
        <Link href={defaultMarket.path} shallow={true}>
          <div
            className={`flex h-16 w-full items-center justify-start border-b border-th-bkg-3 px-4`}
          >
            <div className={`flex flex-shrink-0 cursor-pointer items-center`}>
              ...
              >
                ...
                <img
                className={`h-8 w-auto`}
                src="/assets/icons/solapelogotext.svg"
                alt="next"
              />
                </span>
              </Transition>
  ...
  />
    ...
    />
            ...
            />
            <MenuItem
              active={pathname === '/token-listing'}
              collapsed={false}
              icon={<GiftIcon className="h-4 w-4" />}
              title="Token Listing"
              pagePath="/token-listing"
              hideIconBg
    />
            <MenuItem
              collapsed={false}
            ...
            <MenuItem
              ...
              title={t('Access Card')}
              pagePath="https://magiceden.io/marketplace/solape_access_card"
              hideIconBg
              isExternal
            />
          </ExpandableMenuItem>
