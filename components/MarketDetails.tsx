...
const OraclePrice = () => {
  ...
  return (
    <div className="font-bold text-th-fgd-1 md:text-lg">
...
const MarketDetails = () => {
  ...
  return (
    <div
      className={`relative flex flex-col md:px-3 md:pt-2 md:pb-2 lg:flex-row lg:items-end lg:justify-between`}
    >
      <div className="flex flex-col lg:flex-row lg:flex-wrap">
        ...
        <div className="grid grid-flow-row grid-cols-1 gap-2 md:mt-0.5 md:grid-cols-3 md:pr-20 lg:grid-flow-col lg:grid-cols-none lg:grid-rows-1 lg:gap-6">
          <div className="flex items-center justify-between md:block">
            <div className="text-th-fgd-5 h-4 md:pb-0.5 md:text-[0.65rem]">
              {t('oracle-price')}
            </div>
            <OraclePrice />
          </div>
          {market ? (
            <>
              <div className="flex items-start justify-between md:block">
                ...
                <div
                  className={`md:font-bold text-lg ${
                    market.change24h > 0
                      ? `text-th-green`
                      : market.change24h < 0
                      ? `text-th-red-bright`
              ...
              {isPerpMarket ? (
                <>
                  ...
                  <div className="flex items-center justify-between md:block">
                    ...
                    <div className="text-th-fgd-1 md:text-lg font-bold">
                      {usdFormatter(market?.volumeUsd24h, 0)}
                    </div>
                  </div>
            </>
